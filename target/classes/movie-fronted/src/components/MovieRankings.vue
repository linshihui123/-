        ...
        <div class="ranking-list">
          <div v-for="(item, index) in rankings.highScoreRanking" :key="index" class="ranking-item">
            ...
            <div class="movie-info">
              <div class="movie-name">{{ item.movie && item.movie.name ? item.movie.name : '未知电影' }}</div>
              <div class="movie-meta">
                <el-tag size="mini" type="primary">{{ item.movie && item.movie.type ? item.movie.type : '未知' }}</el-tag>
                <el-tag size="mini">{{ item.movie && item.movie.region ? item.movie.region : '未知' }}</el-tag>
              </div>
